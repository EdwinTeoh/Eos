...
namespace EosScriptCore.Scripts
{
    public class HugeMovingBlock1 : MonoBase
    {
        ...
        void OnUpdate()
        {
            Log.LogInfo(targetPosition.ToString());
        ...
        void OnFixedUpdate()
        {
            ...
            if (direction == 1)
            {
                newPos = Vector3.MoveTowards(transformComponent.Translation, destTransform.Translation, moveSpeed * Physics.GetFixedTimestep());
            ...
            if (direction == -1)
            {
                newPos = Vector3.MoveTowards(transformComponent.Translation, startingPos, moveSpeed * Physics.GetFixedTimestep());
                rb.AddForce((newPos - transformComponent.Translation) * moveSpeed * accel);
