...
namespace EosScriptCore.Scripts
{
    public class VirusScript : MonoBase
    {
        ...
        public void Corrupt()
        {
            ...
            {
                mesh.LoadModel("corrupted_Data_Red.fbx");
                currentcolor = Color.Corrupted_Red;
            }
            if (currentcolor == Color.Blue)
            {
                mesh.LoadModel("corrupted_Data_Blue.fbx");
                currentcolor = Color.Corrupted_Blue;
            }
            if (currentcolor == Color.Yellow)
            {
                mesh.LoadModel("corrupted_Data_Yellow.fbx");
        ...
        public void UnCorrupted()
        {
            ...
            {
                mesh.LoadModel("data_red.fbx");
                currentcolor = Color.Red;
            }
            if (currentcolor == Color.Corrupted_Blue)
            {
                mesh.LoadModel("data_blue.fbx");
                currentcolor = Color.Blue;
            }
            if (currentcolor == Color.Corrupted_Yellow)
            {
                mesh.LoadModel("data_yellow.fbx");
                currentcolor = Color.Yellow;
            }
        }
